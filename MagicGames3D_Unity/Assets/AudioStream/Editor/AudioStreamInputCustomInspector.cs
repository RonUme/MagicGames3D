...
namespace AudioStreamCustomInspector
{
    ...
    public class AudioStreamInputCustomInspector : Editor
    {
        /// <summary>
        /// Resonance plugin
        /// </summary>
            ...
            if (obj.NextVisible(true))
            {
                ...
                do
                {
                    ...
                    foreach (var fieldCondition in boolFieldConditions)
                    {
                        ...
                        {
                            FieldInfo enumField = target.GetType().GetField(fieldCondition.conditionFieldName, BindingFlags.Public | BindingFlags.NonPublic | BindingFlags.Instance);
                            ...
                            if (currentBoolValue != fieldCondition.conditionFieldValue)
                            {
