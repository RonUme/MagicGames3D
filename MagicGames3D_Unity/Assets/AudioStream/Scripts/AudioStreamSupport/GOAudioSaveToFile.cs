...
namespace AudioStream
{
    ...
    public class GOAudioSaveToFile : MonoBehaviour
    {
        ...
        FileStream f;
        BinaryWriter fp;
        public bool savingRunning { get; protected set; }
        uint datalength = 0;
        uint samplerate;
        ushort channels;
        uint bits;
        ...
        {
            // handle correct userspace save location, at least for iOS, Android and WSA
            // https://docs.unity3d.com/ScriptReference/Application-persistentDataPath.html
            var platformDir = string.Empty;
            switch (Application.platform)
            {
                ...
                case RuntimePlatform.WSAPlayerX86:
                    platformDir = Application.persistentDataPath;
                    break;
                default:
                    platformDir = Application.streamingAssetsPath;
                    break;
            }
            this.saveFileName = Path.Combine(platformDir, withFileName);
        ...
        public void StartSaving()
        {
            ...
            this.saveFileName = Path.Combine(platformDir, this.saveFileName);

            /*
             * determine signal properties if not specified - these _should_ match OAFR
             */
            var aconfig = AudioSettings.GetConfiguration();
            this.channels = (ushort)UnityAudio.ChannelsFromUnityDefaultSpeakerMode();
        ...
        public void AddToSave(float[] data)
        {
            ...
            // TODO: allow custom format/bitsize per sample
            int len1 = UnityAudio.FloatArrayToPCM16ByteArray(data, (uint)data.Length, ref this.byteArr);
